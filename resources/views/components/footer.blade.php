```blade
<footer id="contact" class="bg-gray-900 text-gray-300 py-20 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm leading-relaxed">
                    Modern coffee culture for the creative mind. Your workspace,
                    your sanctuary, your community. Established 2024.
                </p>
                ...
                <div class="flex gap-4 mt-6">
                    ...
                    <!-- Facebook -->
                    <a
                        href="https://facebook.com/dastreetcoffee"
                        target="_blank"
                    ...
                    <!-- Instagram -->
                    <a
                        href="https://instagram.com/dastreetcoffee"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <!-- TikTok -->
                    <a
                        href="https://tiktok.com/@dastreetcoffee"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="TikTok"
                        class="text-gray-400 hover:text-orange-400 transition"
                    >
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.1 1.74 2.89 2.89 0 0 1 2.31-4.64 2.86 2.86 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-.01-.01z"/>
                        </svg>
                    </a>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li>
                        <a href="#home" class="text-gray-400 hover:text-orange-400 transition">
                            Home
                        </a>
                    </li>

                    <li>
                        <a href="#features" class="text-gray-400 hover:text-orange-400 transition">
                            Features
                        </a>
                    </li>

                    <li>
                        <a href="#pricing" class="text-gray-400 hover:text-orange-400 transition">
                            Menu
                        </a>
                    </li>

                    <li>
                        <a href="#testimonials" class="text-gray-400 hover:text-orange-400 transition">
                            Reviews
                        </a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li>
                        <a href="#contact" class="text-gray-400 hover:text-orange-400 transition">
                            Contact
                        </a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li class="text-gray-400">
                        <span class="font-semibold text-white">Hours:</span><br>
                        Mon-Sun: 3PM - 12AM
                    </li>
        ...
        <div class="border-t border-gray-800 pt-8">
            <p class="text-center text-gray-500 text-sm">
                © 2024 THE STREET Coffee. All rights reserved. |
